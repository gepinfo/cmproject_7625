...
{ path : 'getallproject', loadChildren: () => import('./getallproject/getallproject.module').then(m => m.GetallprojectModule), canActivate: [AuthGuard] } , 
...
{ path : 'createclient', loadChildren: () => import('./createclient/createclient.module').then(m => m.CreateclientModule), canActivate: [AuthGuard] } , 
{ path : 'createlead', loadChildren: () => import('./createlead/createlead.module').then(m => m.CreateleadModule), canActivate: [AuthGuard] } , 
{ path : 'createplans', loadChildren: () => import('./createplans/createplans.module').then(m => m.CreateplansModule), canActivate: [AuthGuard] } , 
];
