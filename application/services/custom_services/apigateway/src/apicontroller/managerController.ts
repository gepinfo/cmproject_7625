...
export class managerController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/manager/:id', this.GpDelete);
this.router.get('/manager/get/search', this.GpSearch);
this.router.put('/manager/get/update', this.GpSearchForUpdate);
this.router.put('/manager', this.GpUpdate);
this.router.get('/manager', this.GpGetAllValues);
this.router.post('/manager', this.GpCreate);
    }
