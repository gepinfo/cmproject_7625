...
export class leadController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/lead/:id', this.GpDelete);
this.router.get('/lead/get/search', this.GpSearch);
this.router.put('/lead/get/update', this.GpSearchForUpdate);
this.router.put('/lead', this.GpUpdate);
this.router.get('/lead', this.GpGetAllValues);
this.router.post('/lead', this.GpCreate);
    }
